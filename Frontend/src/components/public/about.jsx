  ...
  return (
    <>
      ...
      <section className="w-full min-h-screen bg-gray-50 font-poppins flex flex-col items-center px-0">
        ...
        {/* Hero + Stats */}
        <div className="w-full max-w-6xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between bg-gray-50 px-4   gap-6">
          {/* Left Section */}
          ...
          <div className="w-full lg:w-1/2 flex justify-center relative">
            ...
            <img
              src="short.png" 
              alt="Mobile Banner"
              className="block sm:hidden w-full max-w-xs rounded-xl pt-8"
            />
